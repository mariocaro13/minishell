...
t_commands_list	*ft_command_list_create_node(char **str, int num_redirections,
					t_lexer_list *redirections);
t_commands_list	*ft_command_list_get_first(t_commands_list *map);
void			ft_command_list_add_node_back(t_commands_list **lst,
					t_commands_list *new);

// Del commands
void			ft_command_list_del_first(t_commands_list **lst);
void			ft_command_list_clear(t_commands_list **lst);
